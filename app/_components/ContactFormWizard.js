    ...
    >
      ...
      <div className="mt-6 flex items-center justify-between gap-3">
        <button
          ...
          onClick={goBack}
          disabled={step === 1}
          className="rounded-lg border border-teal-900/10 dark:border-teal-300/15 bg-white/70 dark:bg-white/5 px-5 py-3 font-semibold hover:bg-white/90 dark:hover:bg-white/10 disabled:opacity-50 transition"
        >
          Back
        </button>
        ...
        {step < 3 ? (
          ...
          <button
            type="submit"
            disabled={submitting}
            className="rounded-lg bg-teal-500 px-6 py-3 text-white font-semibold hover:bg-teal-600 disabled:opacity-60 transition"
          >
      ...
      <div className="flex items-center justify-between text-xs font-medium text-slate-600 dark:text-slate-300">
        {labels.map((l, i) => (
          <div key={l} className="flex items-center gap-2">
            ...
            <span
              className={
                i + 1 <= step ? "text-teal-600 dark:text-teal-300" : ""
              }
            >
              {l}
            </span>
            ...
            return (
              <label
                ...
                className={[
                  ...
                  checked
                    ? "border-teal-400 bg-teal-50/60 dark:bg-teal-300/10"
...
function StepThree({ form, setField, errors }) {
  return (
    <>
      ...
      <div className="rounded-xl border border-teal-900/10 dark:border-teal-300/15 bg-white/60 dark:bg-white/5 px-4 py-3">
  ...
  return (
    <div>
      ...
      <input
        ...
        onChange={onChange}
        className={[
          "mt-1 w-full rounded-lg border px-3 py-2 outline-none focus:ring-4 focus:ring-teal-300/30",
    ...
    <div className="relative">
      <select
        ...
        className={[
          ...
          "text-slate-800 dark:text-slate-100",
          "focus:ring-4 focus:ring-teal-300/30 disabled:opacity-60",
        ].join(" ")}
