  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        <Link
          href="#"
          className="flex items-center gap-3 focus:outline-none focus-visible:ring-4 focus-visible:ring-teal-300/35 rounded-lg"
        >
                ...
                <li key={href}>
                  <a
                    ...
                    className={[
                      ...
                      "focus:outline-none focus-visible:ring-4 focus-visible:ring-teal-300/35",
                    ].join(" ")}
                  >
                    {label}
                    <span
                      className={[
                        ...
                        "bg-teal-600/70 dark:bg-teal-300/70",
        ...
        <div className="flex items-center gap-2">
          <a
            href="#contact"
            className="hidden sm:inline-flex items-center rounded-lg bg-teal-500 px-4 py-2 text-white text-sm font-semibold hover:bg-teal-600 transition focus:outline-none focus-visible:ring-4 focus-visible:ring-teal-300/35"
          >
            Request a Quote
          </a>
          <ThemeToggle />
...
function ThemeToggle() {
  ...
  return (
    <button
      ...
      title={label}
      className="ml-1 rounded-full border border-slate-300/70 dark:border-slate-700/70 p-2 bg-white/70 dark:bg-slate-800/70 hover:bg-white dark:hover:bg-slate-700 transition focus:outline-none focus-visible:ring-4 focus-visible:ring-teal-300/35"
    >
...
function MobileMenu({ sections }) {
  ...
  return (
    <>
      <button
        onClick={() => setOpen((s) => !s)}
        className="md:hidden inline-flex items-center justify-center rounded-lg border border-slate-300/70 dark:border-slate-700/70 p-2 bg-white/70 dark:bg-slate-800/70 hover:bg-white dark:hover:bg-slate-700 transition focus:outline-none focus-visible:ring-4 focus-visible:ring-teal-300/35"
        aria-expanded={open}
      ...
      >
        ...
        >
          <div className="px-6 pt-4 pb-2 flex items-center justify-between">
            ...
            <button
              onClick={() => setOpen(false)}
              className="inline-flex items-center justify-center rounded-lg border border-slate-300/70 dark:border-slate-700/70 p-2 bg-white/70 dark:bg-slate-800/70 hover:bg-white dark:hover:bg-slate-700 transition focus:outline-none focus-visible:ring-4 focus-visible:ring-teal-300/35"
          ...
          <div className="px-6 pb-6">
              ...
              {sections.map(([label, href]) => (
                <li key={href}>
                  <a
                    href={href}
                    onClick={() => setOpen(false)}
                    className="block rounded px-3 py-2 text-slate-800 dark:text-slate-100 hover:bg-teal-50 dark:hover:bg-white/10 transition"
                  >
                    {label}
                  </a>
                </li>
            ...
            <div className="mt-4">
              <a
                href="#contact"
                onClick={() => setOpen(false)}
                className="block text-center rounded-lg bg-teal-500 px-4 py-2 text-white font-semibold hover:bg-teal-600 transition"
              >
                Request a Quote
              </a>
            </div>
